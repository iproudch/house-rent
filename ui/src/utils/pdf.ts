...
export const generateBillPDF = (receiptData: IReceiptData) => {
  ...
  doc.setFontSize(9);
  const instructions = [
    "หมายเหตุ: 1. กรุณาโอนเงินเข้าบัญชีตาม QR-Code  ตามที่ระบุในใบแจ้งหนี้นี้เท่านั้น",
    "         2. ค่าไฟฟ้าที่แสดงเป็นค่าไฟที่รวมภาษีแล้ว หากมีการเปลี่ยนแปลงอัตราค่าไฟฟ้าในอนาคต",
    "            จะมีการปรับปรุงใบแจ้งหนี้ให้สอดคล้องกับอัตราใหม่",
    "         3. ค่าน้ำคิดตามอัตราของการประปาส่วนภูมิภาค",
    "             0-10 หน่วย 10.20บาท/หน่วย",
